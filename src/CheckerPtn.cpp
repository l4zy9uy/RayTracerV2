...
const glm::dvec3 &CheckerPtn::getA() const {
  return a;
}
void CheckerPtn::setA(const glm::dvec3 &A) {
  a = A;
}
const glm::dvec3 &CheckerPtn::getB() const {
  return b;
}
void CheckerPtn::setB(const glm::dvec3 &B) {
  b = B;
}
